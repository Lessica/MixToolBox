...
#include <substrate.h>
@class SBIconController; @class SBFolderIconBackgroundView; @class SBVoiceControlController; @class SBSearchResultsBackdropView; @class SBFWallpaperView; @class SBFWallpaperSettings; @class SBAppSwitcherHomePageCellView; @class SBIconPageIndicatorImageSetResult; @class SBIconBetaLabelAccessoryView; @class SBAppParallaxSettings; @class SBIconColorSettings; @class SBIconRecentlyUpdatedLabelAccessoryView; @class SBClockApplicationIconImageView; @class SBDarkeningImageView; @class SBWallpaperController; @class _UIBackdropViewSettings; @class SBSearchScrollView; @class SBDockView; 
