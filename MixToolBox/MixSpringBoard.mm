...
#include <substrate.h>
@class SBIconBetaLabelAccessoryView; @class SBFolderIconBackgroundView; @class SBIconController; @class _UIBackdropViewSettings; @class SBDockView; @class SBFWallpaperSettings; @class SBAppSwitcherHomePageCellView; @class SBDarkeningImageView; @class SBFWallpaperView; @class SBIconRecentlyUpdatedLabelAccessoryView; @class SBAppParallaxSettings; @class SBClockApplicationIconImageView; @class SBIconPageIndicatorImageSetResult; @class SBSearchScrollView; @class SBSearchResultsBackdropView; @class SBWallpaperController; @class SBIconColorSettings; @class SBVoiceControlController; 
...
static void _logos_method$_ungrouped$SBDarkeningImageView$setImage$(SBDarkeningImageView* self, SEL _cmd, id image) { 
    if (rmBadgeBackground && enabled)
        return;
    _logos_orig$_ungrouped$SBDarkeningImageView$setImage$(self, _cmd, image);
}
...
#line 275 "/Users/Zheng/Projects/MixToolBox/MixToolBox/MixSpringBoard.xm"
