...
#include <substrate.h>
@class SBLockScreenView; @class _UIGlintyStringView; @class SBFLockScreenDateView; @class SBLockScreenViewController; @class SpringBoard; 
...
static void _logos_method$_ungrouped$SBFLockScreenDateView$setContentAlpha$withDateVisible$(SBFLockScreenDateView* self, SEL _cmd, double arg1, BOOL arg2) {
	...
	_logos_orig$_ungrouped$SBFLockScreenDateView$setContentAlpha$withDateVisible$(self, _cmd, 0.0,NO);} else { _logos_orig$_ungrouped$SBFLockScreenDateView$setContentAlpha$withDateVisible$(self, _cmd, arg1,arg2); } 
}
...
static void _logos_method$_ungrouped$SBLockScreenView$setTopGrabberHidden$forRequester$(SBLockScreenView* self, SEL _cmd, bool hidden, id requester) {
	...
	} else { _logos_orig$_ungrouped$SBLockScreenView$setTopGrabberHidden$forRequester$(self, _cmd, hidden,requester); }
}
...
static void _logos_method$_ungrouped$SBLockScreenView$setBottomGrabberHidden$forRequester$(SBLockScreenView* self, SEL _cmd, bool hidden, id requester) {
	...
	} else { _logos_orig$_ungrouped$SBLockScreenView$setBottomGrabberHidden$forRequester$(self, _cmd, hidden,requester); }
}
...
static void _logos_method$_ungrouped$SBLockScreenView$setCustomSlideToUnlockText$(SBLockScreenView* self, SEL _cmd, id arg1) {
	...
	} else if (hideText && enabled)
	{
		arg1 = @"";
		_logos_orig$_ungrouped$SBLockScreenView$setCustomSlideToUnlockText$(self, _cmd, arg1);	}
		else { _logos_orig$_ungrouped$SBLockScreenView$setCustomSlideToUnlockText$(self, _cmd, arg1);
		}
}
...
static __attribute__((constructor)) void _logosLocalCtor_46aa1c48() {
...
#line 194 "/Users/Zheng/Projects/MixToolBox/MixToolBox/MixLockScreen.xm"
