...
#include <substrate.h>
@class SBTodayTableHeaderView; @class SBNotificationsAllModeViewController; @class SBNotificationSeparatorView; @class SBTodayBulletinCell; @class SBUIController; @class _SBUIWidgetViewController; @class SBNotificationCenterController; @class SBTodayTableFooterView; @class SBNotificationCenterSeparatorView; @class SBNotificationCenterViewController; @class SBModeViewController; @class SBNotificationCenterHeaderView; @class SBBannerContainerView; 
